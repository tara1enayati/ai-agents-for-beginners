...
Ak je to váš prvý pokus o prácu s generatívnymi AI modelmi, pozrite si náš kurz [Generative AI For Beginners](https://aka.ms/genai-beginners), ktorý obsahuje 21 lekcií o práci s GenAI.
