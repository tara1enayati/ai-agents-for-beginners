...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T15:12:34+00:00",
...
לקורס זה יש תמיכה רב-לשונית. תוכלו למצוא את [השפות הזמינות כאן](../..).
...
אל תשכחו [לסמן כוכב (🌟) למאגר הזה](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ו-[ליצור עותק של המאגר](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי להריץ את הקוד.
...
כל שיעור בקורס כולל דוגמאות קוד, שניתן למצוא בתיקיית code_samples. תוכלו [ליצור עותק של המאגר](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי ליצור עותק משלכם.
...
הקורס עושה שימוש גם במסגרת סוכני AI ושירותים של Microsoft:
...
| הנדסת הקשר עבור סוכני AI            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| ניהול זיכרון סוכני AI                      | [Link](./13-agent-memory/README.md)     |                                                            |                                                                                        |
| הערכת סוכני AI                         | בקרוב - 18 בספטמבר                            |                                                            |                                                                                        |
| בניית סוכנים לשימוש במחשב (CUA)           | בקרוב - 25 בספטמבר                            |                                                            |                                                                                        |
| פריסת סוכנים בקנה מידה רחב                    | בקרוב - 25 בספטמבר                            |                                                            |                                                                                        |
| יצירת סוכני AI מקומיים                     | בקרוב - 3 באוקטובר                               |                                                            |                                                                                        |
| אבטחת סוכני AI                           | בקרוב - 10 באוקטובר                               |                                                            |                                                                                        |
...
תודה ל-[Shivam Goyal](https://www.linkedin.com/in/shivam2003/) על תרומתו עם דוגמאות קוד חשובות המדגימות Agentic RAG. 
...
כאשר אתה מגיש בקשת משיכה (pull request), בוט CLA יבדוק באופן אוטומטי אם עליך לספק
CLA ויעטר את הבקשה בהתאם (לדוגמה, בדיקת סטטוס, תגובה). פשוט עקוב אחר ההוראות
שניתנות על ידי הבוט. תצטרך לעשות זאת רק פעם אחת בכל המאגרים שמשתמשים ב-CLA שלנו.
...
הפרויקט הזה עשוי להכיל סימנים מסחריים או לוגואים עבור פרויקטים, מוצרים או שירותים. שימוש מורשה בסימנים המסחריים או בלוגואים של Microsoft כפוף ל-
