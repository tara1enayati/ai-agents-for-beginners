...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T14:13:56+00:00",
...
اگر یہ آپ کا پہلا موقع ہے جنریٹو AI ماڈلز کے ساتھ کام کرنے کا، تو ہمارا [Generative AI For Beginners](https://aka.ms/genai-beginners) کورس دیکھیں، جس میں GenAI کے ساتھ کام کرنے کے 21 اسباق شامل ہیں۔
...
اس کورس کے کوڈ کو چلانے کے بارے میں مزید معلومات کے لیے، [Course Setup](./00-course-setup/README.md) پر جائیں۔
...
| اے آئی ایجنٹس کے لیے کانٹیکسٹ انجینئرنگ            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| ایجنٹک میموری کا انتظام                      | [Link](./13-agent-memory/README.md)     |                                                            |                                                                                        |
| اے آئی ایجنٹس کا جائزہ                         | دستیاب ہوگا - 18 ستمبر                            |                                                            |                                                                                        |
| کمپیوٹر یوز ایجنٹس (CUA) بنانا           | دستیاب ہوگا - 25 ستمبر                            |                                                            |                                                                                        |
| اسکیل ایبل ایجنٹس کی تعیناتی                    | دستیاب ہوگا - 25 ستمبر                            |                                                            |                                                                                        |
| مقامی اے آئی ایجنٹس بنانا                     | دستیاب ہوگا - 3 اکتوبر                               |                                                            |                                                                                        |
| اے آئی ایجنٹس کو محفوظ بنانا                           | دستیاب ہوگا - 10 اکتوبر                               |                                                            |                                                                                        |
...
Contributor License Agreement (CLA) پر دستخط کرنے کی ضرورت ہوگی، جس میں یہ اعلان کیا جائے گا کہ آپ کے پاس حقوق ہیں اور آپ ہمیں اپنے تعاون کو استعمال کرنے کے حقوق دیتے ہیں۔ تفصیلات کے لیے دیکھیں 
<https://cla.opensource.microsoft.com>۔

جب آپ ایک پل ریکویسٹ جمع کراتے ہیں، تو ایک CLA بوٹ خود بخود یہ طے کرے گا کہ آیا آپ کو CLA فراہم کرنے کی ضرورت ہے اور PR کو مناسب طریقے سے سجائے گا (مثلاً، اسٹیٹس چیک، تبصرہ)۔ بس بوٹ کی فراہم کردہ ہدایات پر عمل کریں۔ آپ کو یہ صرف ایک بار تمام ریپوز کے لیے کرنا ہوگا جو ہمارے CLA استعمال کرتے ہیں۔
...
یہ پروجیکٹ ممکنہ طور پر پروجیکٹس، مصنوعات، یا خدمات کے لیے ٹریڈ مارکس یا لوگوز شامل کر سکتا ہے۔ مائیکروسافٹ کے ٹریڈ مارکس یا لوگوز کے مجاز استعمال کو 
...
کسی بھی تیسرے فریق کے ٹریڈ مارکس یا لوگوز کا استعمال ان تیسرے فریق کی پالیسیوں کے تابع ہوگا۔
