...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T14:18:24+00:00",
...
**如果你希望支持更多語言，請查看[這裡](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
這門課程包含了建立AI代理的基礎知識，每個課程都有自己的主題，你可以從任何地方開始！

此課程支持多語言，請查看我們的[可用語言](../..)。
...
此課程的每個課程都包含代碼示例，這些示例可以在code_samples文件夾中找到。你可以[分叉此倉庫](https://github.com/microsoft/ai-agents-for-beginners/fork)以創建自己的副本。

這些練習中的代碼示例使用了Azure AI Foundry和GitHub模型目錄來與語言模型交互：
...
此課程還使用了以下來自Microsoft的AI代理框架和服務：
...
此專案歡迎貢獻和建議。大多數貢獻需要您同意一份貢獻者許可協議（CLA），聲明您有權並實際授予我們使用您的貢獻的權利。詳情請訪問 
...
此專案可能包含專案、產品或服務的商標或標誌。使用Microsoft商標或標誌需遵守並必須符合
