...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T16:09:47+00:00",
...
Ao discutir os benefícios únicos de criar Agentes de IA, dois aspectos principais são mencionados: a capacidade de utilizar ferramentas para realizar tarefas e a habilidade de melhorar ao longo do tempo. A memória é a base para criar agentes autossuficientes que proporcionam melhores experiências para nossos usuários.
...
• **Tornando Agentes de IA Autossuficientes**: Como a memória permite que os agentes aprendam com interações passadas e melhorem ao longo do tempo.
...
• **Interativos**: Mantendo o contexto em uma conversa contínua.
...
Pense nisso como um pedaço de papel de rascunho que o agente usa durante uma única tarefa ou processo de pensamento. Ele mantém informações imediatas necessárias para calcular o próximo passo.
...
## Tornando Agentes de IA Autossuficientes

Um padrão comum para agentes autossuficientes envolve introduzir um **"agente de conhecimento"**. Esse agente separado observa a conversa principal entre o usuário e o agente primário. Seu papel é:
...
4. **Aumentar consultas futuras**: Quando o usuário inicia uma nova consulta, o agente de conhecimento recupera informações relevantes armazenadas e as adiciona ao prompt do usuário, fornecendo contexto crucial ao agente primário (similar ao RAG).
...
Participe do [Azure AI Foundry Discord](https://aka.ms/ai-agents/discord) para se conectar com outros aprendizes, participar de horários de atendimento e tirar suas dúvidas sobre Agentes de IA.
