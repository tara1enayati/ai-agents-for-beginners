...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T14:49:44+00:00",
...
## Kurs uczący wszystkiego, co musisz wiedzieć, aby zacząć budować AI Agenci
...
Ten kurs zawiera lekcje obejmujące podstawy budowania AI Agenci. Każda lekcja dotyczy osobnego tematu, więc możesz zacząć od dowolnego miejsca!

Kurs wspiera wiele języków. Przejdź do [dostępnych języków tutaj](../..). 
...
Nie zapomnij [dodać gwiazdki (🌟) do tego repozytorium](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) oraz [zforkować repozytorium](https://github.com/microsoft/ai-agents-for-beginners/fork), aby uruchomić kod.
...
Każda lekcja w tym kursie zawiera przykłady kodu, które można znaleźć w folderze code_samples. Możesz [zforkować repozytorium](https://github.com/microsoft/ai-agents-for-beginners/fork), aby stworzyć własną kopię.  
...
| Zrozumienie wzorców projektowych AI Agentic  | [Link](./03-agentic-design-patterns/README.md)   | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Budowanie zaufanych AI Agenci                | [Link](./06-building-trustworthy-agents/README.md)| [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Wzorzec projektowy dla wielu agentów         | [Link](./08-multi-agent/README.md)               | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Korzystanie z protokołów Agentic (MCP, A2A i NLWeb) | [Link](./11-agentic-protocols/README.md)         | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Ocena agentów AI                            | Wkrótce - 18 września                              |                                                            |                                                                                        |
| Tworzenie agentów do obsługi komputera (CUA) | Wkrótce - 25 września                              |                                                            |                                                                                        |
| Wdrażanie skalowalnych agentów              | Wkrótce - 25 września                              |                                                            |                                                                                        |
| Tworzenie lokalnych agentów AI              | Wkrótce - 3 października                           |                                                            |                                                                                        |
| Zabezpieczanie agentów AI                   | Wkrótce - 10 października                          |                                                            |                                                                                        |
